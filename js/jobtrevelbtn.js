...
function flag_job_img(num) {
    switch (num) {
        ...
        case 3:
            ...
            job_img_item[8].src = "images/page9/3/11_pla.png";
        ...
        case 7:
            ...
            job_img_item[8].src = "images/page9/7/09_play_2.png";
...
function pop_windows(url , title) {
    windowsObj = window.open(url, title, 'width=900% , height = 500 , left = 1050, top = 850, toolbars=no,scrollbars=no');
